...
Version:        1.0.0
Release:        3%{?dist}
Summary:        TOTP Library for Go (Golang)
License:        ASL 2.0
...
Requires:      golang(github.com/boombuler/barcode)
Requires:      golang(github.com/boombuler/barcode/qr)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/hotp) = %{version}-%{release}
Provides:      golang(%{import_path}/totp) = %{version}-%{release}
...
%gotest %{import_path}
%gotest %{import_path}/hotp
%gotest %{import_path}/totp
%endif
